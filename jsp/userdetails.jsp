...
<%
	...
	int count=0;
	int num=0;
	String uname="",email="",mobile="",userid="",loginstatus="";
	try
	{
		...
		pst = conn.prepareStatement("select loginstatus from users where uid=?;");
		pst.setString(1,uid1);
		rs=pst.executeQuery();
		while(rs.next())
		{
...
<div id="te_wrapper">
    ...
    <div id="te_main">
    	...
    	<div id="te_sidebar">
            ...
            <div id="te_menu">
                <ul>
                  <li><a href="first.jsp" class="current">Users</a></li>
        ...
        <div id="te_content">
					...
					<tr><td><p>User Id :</p></td><td><input type="text" name="txt1" readonly id="uid" value="<%=uid1%>"></td></tr>
					<tr><td><p>Name :</p></td><td><input type="text" name="uname" id="uname" readonly value="<%=uname%>"></td></tr>
					<tr><td><p>Email :</p></td><td><input type="text" name="email" id="email" readonly  value="<%=email%>"></td></tr>
					<tr><td><p>Mobile :</p></td><td><input type="text" name="mobile" id="mobile" readonly  value="<%=mobile%>"></td></tr>
					<tr><td><p>Login Status :</p></td><td><input type="text" name="status" id="status" readonly value="<%=loginstatus%>"></td><td><input style="width:50px;" type="button" value="Edit" type="button" onclick="setResult('status')"></td></tr>
					<tr><td  colspan="2"><a href="changestatus.jsp?uid3=<%=uid1%>">Save</a></td></tr>
