...
<body>
	...
	try
	{
		...
		pst = conn.prepareStatement("select * from message where mid=? and senderdelete='no';");
	  ...
	  <div id="te_content">
         <div id="contact_form">
					<form name="frm1" action="#" method="POST">
						...
						<input type="text" id="author" name="to" class="required input_field" value="<%=rec%>" disabled="disabled">
						...
						<a href="outboxdelete.jsp?mid=<%=mid%>">Delete</a>
