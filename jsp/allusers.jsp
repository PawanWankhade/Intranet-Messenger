...
<div id="te_wrapper">
	...
	<div id="te_sidebar">
		...
		<tr><th>SrNo</th><th style="padding-left:30px;">User Name</th><th style="padding-left:30px;">User Id</th></tr>
		<%
			Connection conn;
			ResultSet rs;
			Statement st;
			...
			try
			{
				...
				while(rs.next())
				{
					...
					num++;
				%>
				<tr><td><%=num%></td><td>&nbsp;&nbsp;&nbsp;&nbsp;<%=rs.getString("uname")%></td><td><a href='userdetails1.jsp?uid2=<%=rs.getString("uid")%>'><%=rs.getString("uid")%></a></td></tr>
				<%	
				}
				%>
				</table>
